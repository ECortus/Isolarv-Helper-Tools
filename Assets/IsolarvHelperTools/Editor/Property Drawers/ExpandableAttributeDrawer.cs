...
namespace IsolarvHelperTools.Editor
{
    ...
    public class ExpandableAttributeDrawer : PropertyDrawer
    {
        ...
        /// </summary>
        private static BackgroundStyles BACKGROUND_STYLE = BackgroundStyles.Darken;
        ...
        {
            expandableAttribute = attribute as ExpandableAttribute;
            ...
            if (expandableAttribute.ReadOnly)
            {
